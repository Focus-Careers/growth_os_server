...
Your lead generation expert has found some candidate companies for review. The output contains high_score_count (number of target companies found) and total_targets.
...
- A review sidebar has just opened with the candidate companies
- Use the word "companies" — not "leads" or "contacts" — when referring to what was found
