...
- Tighten demographics based on actual customer patterns (e.g. if all customers are SIC 43320 in South East England, say so specifically)
...
Return a valid JSON object with these fields:
{
  ...
  "demographics": "Key demographic indicators based on real customer patterns",
  ...
  "location": "Geographic region based on customer locations"
}
